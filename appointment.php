...
<!--<body>-->
    ...
    <div class="container contact-us">
        <p class="gilroy-dark-48">Make an appointment</p>
        <form action="appointmentprov.php" method="post" action="" class="appointment">
            <div class="columned-inputs">
                ...
                <div class="input-box">
                    ...
                    <input type="date" name="date" class="app-date"    format="DD MMMM YYYY" required >
                </div>

                <div class="input-box">
                    <label for="time">Time</label>
                    <input type="time" name="time" class="app-time" placeholder="Phone Number" required>
                </div>
            </div>
